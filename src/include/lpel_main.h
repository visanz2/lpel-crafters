...
#define PRODLOCK_TYPE       ocr_pthread_mutex_t
#define PRODLOCK_INIT(x)    ocr_pthread_mutex_init(x, NULL)
#define PRODLOCK_DESTROY(x) ocr_pthread_mutex_destroy(x)
#define PRODLOCK_LOCK(x)    ocr_pthread_mutex_lock(x)
#define PRODLOCK_UNLOCK(x)  ocr_pthread_mutex_unlock(x)
