...
#  define __lock_type ocr_pthread_mutex_t
#  define __lock_init(v) (void) ocr_pthread_mutex_init( &(v)->lock, NULL)
#  define __lock_destroy(v) (void) ocr_pthread_mutex_destroy( &(v)->lock)
#  define __lock_get(v) (void) ocr_pthread_mutex_lock( &(v)->lock)
#  define __lock_release(v) (void) ocr_pthread_mutex_unlock( &(v)->lock)
//#endif
