...
MACRO(OpenComRTOS_CompilerOptions)
    ...
    IF(DEFINED OCR_COMPILER_OPTIONS)
        ...
        IF(OCR_COMPILER_OPTIONS STREQUAL "Os")
            ...
            ADD_DEFINITIONS(-O2) # BSP Found bug in GCC (http://gcc.gnu.org/bugzilla/show_bug.cgi?format=multiple&id=43810).
